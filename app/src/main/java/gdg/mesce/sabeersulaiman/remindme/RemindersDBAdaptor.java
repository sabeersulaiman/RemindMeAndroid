 ...
 */
public class RemindersDBAdaptor {
    ...
    public RemindersDBAdaptor(Context ctx) {
        this.mCtx = ctx;
    }
    //open
    ...
    public long createReminder(Reminder reminder) {
        ContentValues values = new ContentValues();
        values.put(COL_CONTENT, reminder.getmContent()); // Content
        values.put(COL_IMPORTANT, reminder.getmImp()); // Important
        // Inserting Row
    ...
    public void updateReminder(Reminder reminder) {
        ...
        values.put(COL_IMPORTANT, reminder.getmImp());
